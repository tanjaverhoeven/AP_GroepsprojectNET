namespace DotnetAcademy.DAL.Migrations
{
    ...
    public partial class InitialMigration : DbMigration
    {
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Name = c.String(nullable: false, maxLength: 100),
                        Level = c.String(nullable: false, maxLength: 25),
                ...
                c => new
                    {
                        ...
                        Postal = c.String(maxLength: 4000),
                        VatNumber = c.String(nullable: false, maxLength: 50),
                        ApplicationUser_Id = c.String(nullable: false, maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.ApplicationUser_Id)
                .Index(t => t.Email, unique: true, name: "IX_X_Email")
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.DetailLine", "ProductId", "dbo.Product");
            ...
            DropForeignKey("dbo.Course", "ProductId", "dbo.Product");
            ...
            DropIndex("dbo.Customer", "IX_X_Email");
            DropIndex("dbo.Invoice", new[] { "CustomerId" });
            DropIndex("dbo.DetailLine", new[] { "ProductId" });
            DropIndex("dbo.DetailLine", new[] { "InvoiceId" });
            DropIndex("dbo.Course", new[] { "ProductId" });
